...
public class Student {
    ...
    public final Student build(final ResultSet resultSet) // resultat sur les requetes sur la base de donnees
            throws SQLException, NoSuchFieldException, IllegalAccessException {
        setFieldsFromResulset(resultSet, "name", "firstname","group");
        return this;
    }
    public final PreparedStatement build(PreparedStatement preparedStatement) //on met dedans la requet prepare2
            throws SQLException, NoSuchFieldException, IllegalAccessException {
