...
public class SelectHighestFloor extends ClientRequest<Object, Integer>{
     ...
     private static final String requestOrder = "SELECT_HIGHEST_FLOOR";
     ...
     public Integer readResult(String body) throws IOException {
         ...
         final int higherFloor = mapper.readValue(body, Integer.class);
         return higherFloor;
     }
 
 
     public static Integer launchSelectHighestFloor() throws IOException, InterruptedException{
         ...
         //Pas besoin d'ID car requete globale
         ...
         try {
             while (!clientRequests.isEmpty()) {
                 ...
                 System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
                 System.out.println("NUMERO ETAGE DANS LA METHODE : " + numeroEtage);
                 final AsciiTable asciiTable = new AsciiTable();
                 asciiTable.addRule();
                 asciiTable.addRow(numeroEtage);
                 asciiTable.addRule();
                 logger.debug("\n{}\n", asciiTable.render());
                 return numeroEtage;
             }
